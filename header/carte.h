...
// Une carte est représentée par une liste d'icones et un nombre d'icones associée
// On a préférer un nombre maximum de carte plutôt qu'une allocation dynamique des tableaux
...
// Calcul l'accélération de l'icone en fonction des autres icones et de sa position sur la carte 
